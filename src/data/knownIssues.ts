export const knownIssues = [
  ...
  {
    issue: "Multiple Actions For the Same Hotkey",
    description: "Currently, users can set multiple actions to the same hotkey for buggy effects. Will be disabled soon. ",
  },
]
